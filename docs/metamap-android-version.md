...
* Added error screen for unexpected errors
* Migration Sending a signal to WebSocket

#### Bug Fixes
* Corrected title texts for Spanish
...
###### 30 March 2023
#### Bug Fixes
* Fixed: Exceptions when new process is started
